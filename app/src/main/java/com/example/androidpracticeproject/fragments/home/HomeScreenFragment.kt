...
import com.example.androidpracticeproject.adapters.NftCollectionRVAdapter
...
class HomeScreenFragment : Fragment() {
    ...
    private fun setupNftCollectionRecyclerView() {
        ...
        rvNftCollection.adapter = NftCollectionRVAdapter(requireContext(), nftDataList) { nftListIndex ->
            navController.navigate(HomeScreenFragmentDirections.actionHomeScreenFragmentToNftCollectionFragment(nftListIndex))
        }
    }
